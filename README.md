...
![Youssef Abbas](https://readme-typing-svg.herokuapp.com?font=Noto+Sans&weight=800&size=40&letterSpacing=2px&duration=2000&pause=2000&color=7bbbff&center=true&vCenter=true&width=600&lines=Youssef+Abbas)

## A Passionate SOC Engineer From 🇪🇬

#### 📫 How to reach me **<youssefmabbasofficial@proton.me>**

### 🌟 A little About Me 🌟
   
<p>I'm <strong>SOC Analyst T1</strong> with 2+ years of experience in <strong>security monitoring</strong>, <strong>incident response</strong>, and <strong>threat detection</strong> across enterprise environments. Skilled in using <strong>SIEM (Splunk/ELK)</strong>, <strong>EDR/XDR</strong>, <strong>IDS/IPS</strong>, firewalls, and endpoint security to analyze <strong>Windows</strong>, <strong>Linux</strong>, and <strong>cloud logs</strong> for <strong>indicators of compromise (IOCs)</strong> and <strong>suspicious activity</strong>. Adept at investigating and escalating incidents based on <strong>SOC playbooks</strong> and <strong>SOPs</strong> to ensure swift and effective response.</p>
<p>Proficient in <strong>Git</strong>, <strong>Linux</strong>, <strong>POSIX Shell</strong>, <strong>PowerShell</strong> and <strong>Python</strong> to automate security workflows, optimize detection and response times, and enhance system reliability. Experienced in <strong>C</strong>, <strong>Zig</strong>, and <strong>Assembly (x86)</strong> for low-level system analysis, helping identify vulnerabilities and secure enterprise environments. Knowledgeable in <strong>HTML</strong>, <strong>CSS</strong>, and <strong>JavaScript</strong> to support internal tools and improve security reporting interfaces and dashboards.</p>
<p>Focused on building secure, efficient systems that support and strengthen security operations.</p>
...
<a href="https://leetcode.com/u/YoussefAbbas/">![LeetCode](https://img.shields.io/badge/LeetCode-000000?style=for-the-badge&logo=LeetCode&logoColor=#d16c06)</a>
<a href="https://tryhackme.com/p/YoussefAbbas">![TryHackMe Badge](https://img.shields.io/badge/TryHackMe-212C42?logo=tryhackme&logoColor=fff&style=for-the-badge)</a>
...
<br/>
<img src="https://tryhackme-badges.s3.amazonaws.com/YoussefAbbas.png" alt="Your Image Badge" />
<br/>
<br/>
<table>
  <tr>
     <td><img src="https://leetcard.jacoblin.cool/YoussefAbbas?theme=dark&font=Noto%20Sans&ext=activity" width="500"></td>
     <td>
